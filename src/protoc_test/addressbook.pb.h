...
class Person :
 ...
 public:
  ...
  public:
  void clear_phones();
  const ::Person_PhoneNumber& phones() const;
  ::Person_PhoneNumber* release_phones();
  ::Person_PhoneNumber* mutable_phones();
  void set_allocated_phones(::Person_PhoneNumber* phones);
...
inline bool Person::has_phones() const {
  return this != internal_default_instance() && phones_ != nullptr;
}
...
inline const ::Person_PhoneNumber& Person::phones() const {
  const ::Person_PhoneNumber* p = phones_;
  // @@protoc_insertion_point(field_get:Person.phones)
  return p != nullptr ? *p : *reinterpret_cast<const ::Person_PhoneNumber*>(
      &::_Person_PhoneNumber_default_instance_);
}
inline ::Person_PhoneNumber* Person::release_phones() {
  // @@protoc_insertion_point(field_release:Person.phones)
  
  ::Person_PhoneNumber* temp = phones_;
  phones_ = nullptr;
  return temp;
}
inline ::Person_PhoneNumber* Person::mutable_phones() {
  
  if (phones_ == nullptr) {
    auto* p = CreateMaybeMessage<::Person_PhoneNumber>(GetArenaNoVirtual());
    phones_ = p;
  }
  // @@protoc_insertion_point(field_mutable:Person.phones)
  return phones_;
}
inline void Person::set_allocated_phones(::Person_PhoneNumber* phones) {
  ...
  phones_ = phones;
  // @@protoc_insertion_point(field_set_allocated:Person.phones)
}
